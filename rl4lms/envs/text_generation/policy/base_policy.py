...
class LMActorCriticPolicy(BasePolicy):
    def __init__(
        ...
        self.value_device = torch.device('cuda:1')
        self.ref_device = torch.device('cuda:2')
    ...
    def generate(
        ...
        # generate
        # print(self._policy_model.deivce)
        # print(input_ids.device) # cuda:0
        # print(attention_mask.device) # cuda:0
        # print(self.get_policy_first_device()) # cuda
        # self._policy_model.module.base_model.to(input_ids.device)
        # self._policy_model.to(input_ids.device)
