...
# TOKENIZER = AutoTokenizer.from_pretrained("/mnt/workspace/user/gaojingsheng/LLM/retrieval/FinetuneT5/flan-t5-base-warm-up/checkpoint-5000")
...
class PPO(OnPolicyAlgorithm):
    ...
    def __init__(
        ...
        clip_range_vf: Union[None, float, Schedule] = None, # 0.2, # None,
        ...
        for epoch in range(self.n_epochs):
            ...
            for batch_ix, rollout_data in enumerate(list(self.rollout_buffer.get(self.batch_size))):
                ...
                if isinstance(self.action_space, spaces.Discrete):
                    ...
                    #     words = TOKENIZER.decode(int(action))
                    #     print(words)
                ...
                # direct use the policy loss 2 as the loss function
                ...
                if entropy is None: # torch.Size([32]) batchsize
                ...
                if (batch_ix + 1) % self.gradient_accumulation_steps == 0:
                    # Clip grad norm
